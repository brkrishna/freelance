...
function _fly_flower_settings_form(array &$form, array $form_state) {
  ...
  // USDA Organic
  $form['general_settings']['socials']['usda_organic'] = array(
    '#type' => 'textfield',
    '#title' => t('USDA Organic'),
    '#default_value' => theme_get_setting('usda_organic'),
  );
  // Non GMO
  $form['general_settings']['socials']['non_gmo'] = array(
    '#type' => 'textfield',
    '#title' => t('Non GMO'),
    '#default_value' => theme_get_setting('non_gmo'),
  );
  // Kosher
  $form['general_settings']['socials']['kosher'] = array(
    '#type' => 'textfield',
    '#title' => t('Kosher'),
    '#default_value' => theme_get_setting('kosher'),
  );
  // EU Organic
  $form['general_settings']['socials']['eu_organic'] = array(
    '#type' => 'textfield',
    '#title' => t('EU Organic'),
    '#default_value' => theme_get_setting('eu_organic'),
  );
  // Vegan
  $form['general_settings']['socials']['vegan'] = array(
    '#type' => 'textfield',
    '#title' => t('Vegan'),
    '#default_value' => theme_get_setting('vegan'),
  );
  // Footer.
  $form['footer'] = array(
    '#type' => 'fieldset',
