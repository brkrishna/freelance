...
class Migration_Install_activity_type_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Activity_Type.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Activity_Type.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Activity_Type.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Activity_Type.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
