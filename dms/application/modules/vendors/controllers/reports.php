...
class reports extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Vendors.Reports.View');
	...
	{
		$this->auth->restrict('Vendors.Reports.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_vendors())
			{
				...
				redirect(SITE_AREA .'/reports/vendors');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Vendors.Reports.Edit');
		...
		{
			$this->auth->restrict('Vendors.Reports.Delete');
