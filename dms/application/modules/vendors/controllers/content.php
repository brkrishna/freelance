...
class content extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Vendors.Content.View');
	...
	{
		$this->auth->restrict('Vendors.Content.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_vendors())
			{
				...
				redirect(SITE_AREA .'/content/vendors');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Vendors.Content.Edit');
		...
		{
			$this->auth->restrict('Vendors.Content.Delete');
