...
class developer extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Vendors.Developer.View');
	...
	{
		$this->auth->restrict('Vendors.Developer.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_vendors())
			{
				...
				redirect(SITE_AREA .'/developer/vendors');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Vendors.Developer.Edit');
		...
		{
			$this->auth->restrict('Vendors.Developer.Delete');
