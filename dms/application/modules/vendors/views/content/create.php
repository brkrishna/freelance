		...
		<fieldset>
			...
			<?php // Change the values in this array to populate your dropdown as required
				if (is_array($countries_select) && count($countries_select)) :	
					echo form_dropdown('vendors_country', $countries_select, set_value('vendors_country', isset($vendors['country']) ? $vendors['country'] : ''), 'Country'. lang('bf_form_label_required'));
				endif;
			?>
			...
			<div class="form-actions">
				<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('vendors_action_create'); ?>"  />
				<?php echo lang('bf_or'); ?>
				<?php echo anchor(SITE_AREA .'/content/vendors', lang('vendors_cancel'), 'class="btn btn-warning"'); ?>
