...
<div class="admin-box">
	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<div class="control-group <?php echo form_error('vendor_profile_name') ? 'error' : ''; ?>">
				...
				<div class='controls'>
					...
					<span class='help-inline'><?php echo form_error('vendor_profile_name'); ?></span>
				</div>
			</div>
			...
			<div class="control-group <?php echo form_error('vendor_profile_est_start_yr') ? 'error' : ''; ?>">
				...
				<div class='controls'>
					...
					<span class='help-inline'><?php echo form_error('vendor_profile_est_start_yr'); ?></span>
				</div>
			</div>
            
			<div class="control-group <?php echo form_error('vendor_profile_website') ? 'error' : ''; ?>">
				...
				<div class='controls'>
					...
					<span class='help-inline'><?php echo form_error('vendor_profile_website'); ?></span>
				</div>
			</div>
            
			<div class="control-group <?php echo form_error('vendor_profile_profile') ? 'error' : ''; ?>">
				...
				<div class='controls'>
					...
					<span class='help-inline'><?php echo form_error('vendor_profile_profile'); ?></span>
				</div>
			</div>
            
			<div class="form-actions">
				<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('vendor_profile_action_create'); ?>"  />
				<?php echo lang('bf_or'); ?>
