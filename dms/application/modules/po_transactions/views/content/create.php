...
<div class="admin-box">
	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
          ...
          echo form_dropdown('po_transactions_trans_type', $options, set_value('po_transactions_status', isset($po_transactions['trans_type']) ? $po_transactions['trans_type'] : ''), 'Trans Type'. lang('bf_form_label_required'));
			?>
            ...
            <div class = "row" >
				...
				<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('po_transactions_action_create'); ?>"  />
				<?php echo lang('bf_or'); ?>
