...
<div class="admin-box">
	<h3>Todo</h3>
	<?php echo form_open_multipart($this->uri->uri_string(), 'class="inline"'); ?>
        <fieldset>
            <div class="span5">
                ...
                <?php // Change the values in this array to populate your dropdown as required
                    ...
                    echo form_dropdown('todo_status', $options, set_value('todo_status', isset($todo['status']) ? $todo['status'] : ''), 'Status');
                ?>
