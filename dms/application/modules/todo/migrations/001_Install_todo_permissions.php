...
class Migration_Install_todo_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Todo.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Todo.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Todo.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Todo.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Todo.Reports.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Todo.Reports.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Todo.Reports.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Todo.Reports.Delete',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Todo.Settings.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Todo.Settings.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Todo.Settings.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Todo.Settings.Delete',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Todo.Developer.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Todo.Developer.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Todo.Developer.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Todo.Developer.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
