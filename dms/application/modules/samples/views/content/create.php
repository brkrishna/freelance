	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<div class="control-group <?php echo form_error('samples_comments') ? 'error' : ''; ?>">
				...
				<div class='controls'>
					<?php echo form_textarea( array( 'name' => 'samples_comments', 'id' => 'samples_comments', 'rows' => '5', 'cols' => '80', 'value' => set_value('samples_comments', isset($inquiries['comments']) ? $inquiries['comments'] : '') ) ); ?>
