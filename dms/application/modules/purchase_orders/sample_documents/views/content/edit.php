		...
		<fieldset>
			...
			<?php // Change the values in this array to populate your dropdown as required
                if (is_array($samples_select) && count($samples_select)) :
				    echo form_dropdown('sample_documents_sample_id', $sample_select, set_value('sample_documents_sample_id', isset($sample_documents['sample_id']) ? $sample_documents['sample_id'] : ''), 'Sample'. lang('bf_form_label_required'));
                endif;
			?>
