...
class reports extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Sample_Documents.Reports.View');
	...
	{
		$this->auth->restrict('Sample_Documents.Reports.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_sample_documents())
			{
				...
				redirect(SITE_AREA .'/reports/sample_documents');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Sample_Documents.Reports.Edit');
		...
		{
			$this->auth->restrict('Sample_Documents.Reports.Delete');
