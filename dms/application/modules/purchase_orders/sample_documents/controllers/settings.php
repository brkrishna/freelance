...
class settings extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Sample_Documents.Settings.View');
	...
	{
		$this->auth->restrict('Sample_Documents.Settings.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_sample_documents())
			{
				...
				redirect(SITE_AREA .'/settings/sample_documents');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Sample_Documents.Settings.Edit');
		...
		{
			$this->auth->restrict('Sample_Documents.Settings.Delete');
