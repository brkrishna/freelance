                ...
                <div class="span4">
                    <?php // Change the values in this array to populate your dropdown as required
                        if (is_array($pos_select) && count($pos_select)) :    
                            echo form_dropdown('po_documents_po_no', $pos_select, set_value('po_documents_po_no', isset($po_documents['po_no']) ? $po_documents['po_no'] : ''), 'PO No'. lang('bf_form_label_required'), 'tabindex="1"');
                        endif;
                    ?>
                ...
                <div class="span4">
                    <?php // Change the values in this array to populate your dropdown as required
                        if (is_array($products_select) && count($products_select)) :    
                            echo form_dropdown('po_documents_product_id', $products_select, set_value('po_documents_product_id', isset($po_documents['product_id']) ? $po_documents['product_id'] : ''), 'Product', 'tabindex="3"');
                        endif;
                    ?>
