...
class Migration_Install_po_documents_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'PO_Documents.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'PO_Documents.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'PO_Documents.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'PO_Documents.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
