		...
		<fieldset>
            <div class="row">
                <div class="span4">
                    <?php // Change the values in this array to populate your dropdown as required
                        if(isset($po_data)):
                            $i_po_no = $po_data->id;
                            $i_po_qty = $po_data->qty;
                            $i_po_packing_mode = $po_data->packing_mode;
                            $i_po_uom = $po_data->uom_id;
                            $i_po_no_of_units = $po_data->no_of_units;
                            $i_po_product = $po_data->product_id;
                        else:
                            $i_po_no = isset($po_fulfillment['po_no']) ? $po_fulfillment['po_no'] : '';
                            $i_po_qty = isset($po_fulfillment['qty']) ? $po_fulfillment['qty'] : '';
                            $i_po_packing_mode = isset($po_fulfillment['packing_mode']) ? $po_fulfillment['packing_mode'] : '';
                            $i_po_uom = isset($po_fulfillment['uom_id']) ? $po_fulfillment['uom_id'] : '';
                            $i_po_no_of_units = isset($po_fulfillment['no_of_units']) ? $po_fulfillment['no_of_units'] : '';    
                            $i_po_product = isset($po_fulfillment['product_id']) ? $po_fulfillment['product_id'] : '';
                        endif;

                        if (is_array($pos_select) && count($pos_select)) :    
                            echo form_dropdown('po_fulfillment_po_no', $pos_select, set_value('po_fulfillment_po_no', $i_po_no), 'PO No'. lang('bf_form_label_required'), 'tabindex="1"');
                        endif;
                    ?>
                    ...
                    <div class="control-group <?php echo form_error('qty') ? 'error' : ''; ?>">
                        ...
                        <div class='controls'>
                            <input tabindex="4" id='po_fulfillment_qty' type='text' name='po_fulfillment_qty' maxlength="19" value="<?php echo set_value('po_fulfillment_qty', $i_po_qty); ?>" />
                        ...
                        <div class="control-group <?php echo form_error('no_of_units') ? 'error' : ''; ?>">
                            ...
                            <div class='controls'>
                                <input tabindex="7" id='po_fulfillment_no_of_units' type='text' name='po_fulfillment_no_of_units' maxlength="19" value="<?php echo set_value('po_fulfillment_no_of_units', $i_po_no_of_units); ?>" />
                ...
                <div class="span4">
                        ...
                        <?php // Change the values in this array to populate your dropdown as required
                            if (is_array($uoms_select) && count($uoms_select)) :    
                                echo form_dropdown('po_fulfillment_uom_id', $uoms_select, set_value('po_fulfillment_uom_id', $i_po_uom), 'UOM'. lang('bf_form_label_required'), 'tabindex="5"');
                            endif;
                        ?>
                    ...
                    <?php // Change the values in this array to populate your dropdown as required
                        ...
                        echo form_dropdown('po_fulfillment_packing_mode', $options, set_value('po_fulfillment_packing_mode', $i_po_packing_mode), 'Mode of Packing'. lang('bf_form_label_required'), 'tabindex="8"');
                    ?>
                ...
                <div class="span4">
                    ...
                    <?php // Change the values in this array to populate your dropdown as required
                        if (is_array($products_select) && count($products_select)) :    
                            echo form_dropdown('po_fulfillment_product_id', $products_select, set_value('po_fulfillment_product_id', $i_po_product), 'Product'. lang('bf_form_label_required'), 'tabindex="3"');
                        endif;
                    ?>
            ...
            <div class="row">
                <div class="form-actions">
                    ...
                    <?php echo lang('bf_or'); ?>
                    <?php echo anchor(SITE_AREA .'/content/purchase_orders/po_details/' .  $id, 'PO Details', 'class="btn btn-info"'); ?>
                </div>
