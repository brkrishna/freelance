...
class Migration_Install_drums_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Drums.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Drums.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Drums.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Drums.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Drums.Reports.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Drums.Reports.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Drums.Reports.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Drums.Reports.Delete',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Drums.Settings.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Drums.Settings.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Drums.Settings.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Drums.Settings.Delete',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Drums.Developer.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Drums.Developer.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Drums.Developer.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Drums.Developer.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
