...
<div class="admin-box">
	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<div class="control-group <?php echo form_error('office_phones') ? 'error' : ''; ?>">
			...
			<div class="control-group <?php echo form_error('vendor_address_office_fax') ? 'error' : ''; ?>">
				<?php echo form_label('Office Fax', 'vendor_address_office_fax', array('class' => 'control-label') ); ?>
				<div class='controls'>
					<input id='vendor_address_website_url' type='text' name='vendor_address_office_fax' maxlength="255" value="<?php echo set_value('vendor_address_office_fax', isset($vendor_address['office_fax']) ? $vendor_address['office_fax'] : ''); ?>" />
					<span class='help-inline'><?php echo form_error('vendor_address_office_fax'); ?></span>
				</div>
			</div>

			<div class="form-actions">
				<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('vendor_address_action_create'); ?>"  />
				<?php echo lang('bf_or'); ?>
