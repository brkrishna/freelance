...
class Migration_Install_factory_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Factory.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Factory.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Factory.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Factory.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
