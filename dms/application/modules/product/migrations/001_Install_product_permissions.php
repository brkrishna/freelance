...
class Migration_Install_product_permissions extends Migration
{
	...
	private $permission_values = array(
		...
		array(
			'name' => 'Product.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Product.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Product.Reports.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Product.Reports.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Product.Reports.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Product.Reports.Delete',
			'description' => '',
			'status' => 'active',
		),
		array(
		...
		array(
			'name' => 'Product.Developer.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Product.Developer.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Product.Developer.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Product.Developer.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
