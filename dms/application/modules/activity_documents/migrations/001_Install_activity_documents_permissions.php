...
class Migration_Install_activity_documents_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Activity_Documents.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Activity_Documents.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Activity_Documents.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Activity_Documents.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
