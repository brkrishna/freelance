...
class Migration_Install_po_containers_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'PO_Containers.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'PO_Containers.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'PO_Containers.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'PO_Containers.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
