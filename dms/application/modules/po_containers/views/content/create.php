		...
		<fieldset>
            ...
            <?php // Change the values in this array to populate your dropdown as required
                if(isset($po_data)):
                    ...
                    $i_po_no = isset($po_containers['po_no']) ? $po_containers['po_no'] : '';
                endif;
            ?>

			<?php // Change the values in this array to populate your dropdown as required
                if (is_array($pos_select) && count($pos_select)) :    
				    echo form_dropdown('po_containers_po_no', $pos_select, set_value('po_containers_po_no', $i_po_no), 'PO No'. lang('bf_form_label_required'));
                endif;
			?>
			...
			<div class="form-actions">
				<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('po_containers_action_create'); ?>"  />
				<?php echo lang('bf_or'); ?>
