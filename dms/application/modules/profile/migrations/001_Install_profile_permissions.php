...
class Migration_Install_profile_permissions extends Migration
{
	...
	private $permission_values = array(
		...
		array(
			'name' => 'Profile.Settings.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Profile.Settings.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
		...
		array(
			'name' => 'Profile.Developer.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Profile.Developer.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Profile.Developer.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Profile.Developer.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
