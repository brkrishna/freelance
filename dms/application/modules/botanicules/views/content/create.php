                ...
                <div class="control-group <?php echo form_error('botanicules_structure') ? 'error' : ''; ?>">
                    ...
                    <div tabindex="1" class='controls'>
                        <applet code="JME.class" name="JME" archive="/public/JME.jar" width="360" height="315" id="JME">
                            <param name="jme" value="<?php if(isset($botanicules['structure'])) { echo ($botanicules['structure']); } ?>">
                             You have to enable Java and JavaScript in your browser to use JME!
                         </applet>
                        
                        <input type="hidden" id='botanicules_structure' name='botanicules_structure' maxlength="4000" value="<?php echo set_value('botanicules_structure', isset($_POST['structure']) ? $_POST['structure'] : ''); ?>" />
