...
class Migration_Install_todo_list_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Todo_List.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Todo_List.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Todo_List.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Todo_List.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
