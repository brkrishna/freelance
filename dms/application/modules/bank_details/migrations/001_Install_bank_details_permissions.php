...
class Migration_Install_bank_details_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Bank_Details.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Bank_Details.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Bank_Details.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Bank_Details.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
