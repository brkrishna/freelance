...
class Base_Controller extends MX_Controller
{
    ...
    protected $curr_user_profile = NULL;
	/**
	 * Class constructor
	 *
	 */
    ...
    {
        $user_id = NULL;
        $this->load->model('profile/profile_model', null, true);
		...
		$records = $this->profile_model->find_all_by('created_by', $user_id);
        
        if ($records != NULL){
            foreach($records as $record){
                $this->curr_user_profile = array('id'=>$record->id);
            }
        }
        ...
        Template::set('curr_user_profile', $this->curr_user_profile);
    }
