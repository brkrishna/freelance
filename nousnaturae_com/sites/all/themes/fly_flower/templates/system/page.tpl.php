		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="social-list pull-right">
					<ul>
						<li><a href="<?php print theme_get_setting('usda_organic'); ?>" class="usda_organic">USDA Organic</a></li>
						<li><a href="<?php print theme_get_setting('non_gmo'); ?>" class="non_gmo">Non GMO</a></li>
						<li><a href="<?php print theme_get_setting('kosher'); ?>" class="kosher">Kosher</a></li>
						<li><a href="<?php print theme_get_setting('eu_organic'); ?>" class="eu_organic">EU Organic</a></li>
						<li><a href="<?php print theme_get_setting('vegan'); ?>" class="vegan">Vegan</a></li>
					</ul>
				</div>        
			</div>
