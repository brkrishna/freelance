...
class Migration_Install_labels_permissions extends Migration
{
	/**
	...
	private $permissionValues = array(
		array(
			'name' => 'Labels.Content.View',
			'description' => 'View Labels Content',
			'status' => 'active',
		),
		array(
			'name' => 'Labels.Content.Create',
			'description' => 'Create Labels Content',
			'status' => 'active',
		),
		array(
			'name' => 'Labels.Content.Edit',
			'description' => 'Edit Labels Content',
			'status' => 'active',
		),
		array(
			'name' => 'Labels.Content.Delete',
