...
class Migration_Install_standards_documents_permissions extends Migration
{
	...
	private $permissionValues = array(
		array(
			...
			'description' => 'View Standards_documents Content',
			'status' => 'active',
		),
		array(
			'name' => 'Standards_documents.Content.Create',
			'description' => 'Create Standards_documents Content',
			'status' => 'active',
		),
		array(
			'name' => 'Standards_documents.Content.Edit',
			'description' => 'Edit Standards_documents Content',
			'status' => 'active',
		),
		array(
			'name' => 'Standards_documents.Content.Delete',
			'description' => 'Delete Standards_documents Content',
			'status' => 'active',
		),
    );
