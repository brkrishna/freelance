				...
				try:
					...
					for province in provinces:
						...
						while counter <= loop_count:
							...
							time.sleep(random.randint(MIN_WAIT, MAX_WAIT))
							dettagli_details = d.find_elements_by_xpath("//div[@id='divCPList' or @id='divMezziList']/input[@value='Dettagli']")
							...
							try:
								...
								trs = tree.xpath("//div[@id='divCerListDetail']/table//tr")
								print(len(trs))
								if len(trs) > 0:
									for tr in trs:
