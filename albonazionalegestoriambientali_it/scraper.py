...
def main():
    d = conn = None
    try:
        conn = sqlite3.connect("companies.db3")
        d = webdriver.Firefox()
        d.get(URL)
            ...
            try:
                ...
                try:
                    ...
                    for province in provinces:
                        ...
                        d.find_element_by_xpath('//*[@id="risultatiPerPagina"]/option[@value="25"]').click()
                        ...
                        while dettaglis != None:
                            ...
                            while counter < loop_count:
                                ...
                                try:
                                    ...
                                    try:
                                        ...
                                        pass
                                    cur = conn.cursor()
                                    sql = "insert or ignore into companies(impresa, p_iscrizione, n_iscrizione, denominazione, codicefiscale, via, cap, comune, sigla_provincia, raw_text) values"
                                    sql += "(?,?,?,?,?,?,?,?,?,?)"
                            ...
                            print(new_url)
                            d.get(new_url)
                            time.sleep(random.randint(MIN_WAIT/2, MAX_WAIT/2))
                            dettaglis = d.find_elements_by_xpath("//div[@id='divListaImprese']//input[@value='Dettagli']")
                            if dettaglis == None:
                                break
