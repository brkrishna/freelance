				...
				<div class="col-md-6 col-sm-8">
					<div class="service">
						...
						<form class="form-inline" method="POST" action="<?php echo base_url('/index.php/Contactus/inquire'); ?>" id="contactus" name="contactus">
							...
							<div class="form-group">
								<label>Subject</label>
								<input type="text" name="c_subject" id="c_subject" placeholder="Subject..." class="form-control" style="width:150%;" title="Please enter the subject" value="Interested in <?php echo set_value('c_subject', isset($subject) ? $subject : '...'); ?>" />    
							</div>
							<hr/>
							<div class="form-group <?=(null != form_error('c_notes')?'has-error':''); ?>">
								<textarea name="c_notes" id="c_notes" placeholder="Notes..." class="form-control" rows="4" cols="40" title="Please enter your comments / queries / feedback / questions..."></textarea>
							</div>
							<hr/>
