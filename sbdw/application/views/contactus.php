...
<div class="row">
    <div class="col-md-6 col-sm-8">
        <div class="service">
            ...
            <h3>Contact Us</h3>
            <hr/>    
            <form class="form-inline" method="POST" action="<?php echo base_url('/index.php/Contactus'); ?>" id="contactus" name="contactus">
                ...
                <br/><br/>
                <div class="form-group">
                    <input type="text" name="c_subject" id="c_subject" placeholder="Subject..." class="form-control" title="Please enter the subject"/>    
                </div>
                <hr/>
